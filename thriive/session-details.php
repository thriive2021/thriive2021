...
<?php
	...
	$sessiondata = $wpdb->get_results("SELECT o.id,o.remaining_session,d.therapy_name,d.tid,d.uid,o.package,o.pkgdescription FROM online_consultation o,online_session_details d WHERE d.uid = '". $current_user->ID ."'  AND payment_status = 'success'  AND o.id = d.oc_id  ORDER BY o.id DESC ");
