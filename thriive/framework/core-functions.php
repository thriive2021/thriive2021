...
function getOnlineConsultation(){
	...
	$html .= "<table class='wp-list-table widefat fixed striped pages'>";
	$html .= "<thead><tr><td>User Name</td><td>User Email</td><td>User Mobile</td><td>Action</td><td>Remaining Session </td><td>Booked Therapist</td><td>Changed Therapist</td><td>Therapist Mobile</td><td>Total Therapist Change Count</td><td>Package</td><td>Therapy Name</td><td>Amount</td><td>Call/Chat Status</td><td>Payment Status</td><td>Txid</td><td>Created Date</td><td>Call / Chat  Time </td><td>Duration </td></tr></thead>";
