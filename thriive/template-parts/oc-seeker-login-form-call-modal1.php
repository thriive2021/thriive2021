...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-12 mx-sm-auto p-0 text-center" id="reg_unhide" style="display: none;">
        <form data-parsley-validate class="form-element-section w-100" action="" method="post">
            ...
            <?php if(get_query_var("payment")){ ?>
                <input type="hidden" id="payment" value="1">
            <?php } ?>
            ...
            <button class="login_btn" type="submit" name="verify_mobile" id="verify_mobile" style="font-family: Roboto;">Login</button>
        </form>
    </div>
    <div class="col-md-3 col-xs-12"></div>
</div>
