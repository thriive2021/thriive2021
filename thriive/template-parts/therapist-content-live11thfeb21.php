		  ...
		  if(get_query_var('payment_type')){
           ...
           <?php  
            ...
            <?php }else if(get_sub_field('video_call_button') == 1){?>
              <a class="btnChatnow book_now_link_oc" id="book_now_<?php echo get_the_id(); ?>" data-action="videocall" data-slug="<?php echo $post->post_name; ?>" data-from_status="<?php echo $from_status; ?>" data-therapy="<?php echo get_query_var("therapy")[0]; ?>" ><i class="fa fa-calendar" aria-hidden="true"></i>VideoCall</a>
            <?php }										  
          }
        }
      endwhile; 
