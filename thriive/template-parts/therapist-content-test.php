      ...
      while ( have_rows('button_enabled','option') ) : the_row();
        ...
        if(in_array(get_query_var("therapy")[0], $temparr)){ ?> 
		  ...
		  if(get_query_var('payment_type')){
				...
				?>
					 <a class="btnCallnow consult_online_link_oc" id="consult_online_<?php echo get_the_id(); ?>" data-slug="<?php echo $post->post_name; ?>" data-from_status="<?php echo $from_status; ?>" data-therapy="<?php echo get_query_var("therapy")[0]; ?>" style="<?php if($status == "Busy") { echo 'background-color: #80808075 !important;color:#000;'; } ?>"><i class="fa fa-phone" aria-hidden="true" style="color: #fff;"></i>Call Now</a>
           ...
           <?php  
			...
			?>
					<a class="btnCallnow  consult_online_link_oc " id="consult_online_<?php echo get_the_id(); ?>" data-slug="<?php echo $post->post_name; ?>" data-from_status="<?php echo $from_status; ?>" data-therapy="<?php echo get_query_var("therapy")[0]; ?>" data-remaining="0" style="<?php if($status == "Busy") { echo 'background-color: #80808075 !important;color:#000;'; } ?>"><i class="fa fa-phone" aria-hidden="true" style="color: #fff;"></i>Call Now </a>
					<input type="hidden" id="chat_event" value="<?php echo $event; ?>">
					<a class="btnChatnow <?php if($status != "Busy") { echo "start_chat_oc";}?>" data-img="<?php echo $url; ?>" data-fromuserid="<?php echo $seeker_id; ?>" data-touserid="<?php echo $therapist_id; ?>" data-tousername="<?php echo $name; ?>" data-from_status="<?php echo $from_status; ?>"   data-to_status = "<?php echo $to_status; ?>" data-mobile="" data-msg="<?php echo $msg; ?>" data-slug="<?php echo $post->post_name; ?>" data-therapy="<?php echo get_query_var("therapy")[0]; ?>" data-email="<?php echo $therapist_email; ?>"  data-role="<?php echo $role1; ?>" style="<?php if($status == "Busy") { echo 'background-color: #80808075 !important;color:#000;'; } ?>"><i class="fa fa-comments-o" aria-hidden="true" ></i>Chat Now </a>
            <?php  
