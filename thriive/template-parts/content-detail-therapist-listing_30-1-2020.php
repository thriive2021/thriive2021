<div class="d-flex col-12 col-sm-12 mt-10 wrapper-listing section-wrapper-listing p-0 flex-wrap" itemscope itemtype="http://schema.org/Physician" itemprop="Physician">
	...
	<div class="col-sm-6 col-xs-8 col-lg-8 txt-wrap " style="padding:0px 8px;">
		...
		<div itemprop="address" itemscope itemtype="http://schema.org/PostalAddress" class="col-md-8 col-xs-12 font-14">
			...
			if($area) { ?>
				<p style="font-family: Segoe UI;" class=' m-0'>
					...
					<?php if(is_mobile()){ 
					 if($post->distance) {echo '<span class="fa fa-map-marker fa-md mg-5"></span>'.$post->distance; }
				} ?>
				</p>
			<?php } ?>
		</div>
