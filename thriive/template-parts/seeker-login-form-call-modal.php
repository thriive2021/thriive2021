...
<div class="row">
    ...
    <div class="col-sm-6 col-xs-12 mx-sm-auto p-0 text-center" id="reg_hide">
        ...
        <div class="" style="padding:0px 5px">
            <form data-parsley-validate id="call_seeker_signup_btn" class="form-element-section w-100" action="" method="post">
            ...
            <?php } ?>
                <div class="form-group">
                    <input style="border-color: #ced4da !important;" data-parsley-required-message="Email is required." data-parsley-required="true" type="email" class="form-control" id="email-id" name="email-id" placeholder="Enter your email*">
                </div>
                <div class="form-group">
                    <input data-parsley-required="true" type="text" parsley-type="number" style="border-color:#ced4da !important"data-parsley-required-message="Mobile is required." class="form-control model_form_input international-number" id="mobile-number" autocomplete="off" placeholder="Enter your mobile" name="mobile">
                </div>
                <input type="hidden" id="event_name">
                <button type="submit" class="btn btn-primary" name="call_seeker_signup_btn" id="call_seeker_signup_btn">Get Started</button>
            </form>
    ...
    <div class="col-sm-6 col-xs-12 mx-sm-auto p-0 text-center" id="reg_unhide" style="display: none;">
        <form data-parsley-validate class="form-element-section w-100" action="" method="post">
            ...
            <div id="otp_field">
                ...
                <p id="otp_msg"></p>
                <input data-parsley-type="text" style="border-color:#ced4da !important" data-parsley-required-message="OTP is required." data-parsley-required="false" type="text" class="form-control model_form_input" id="mobile-otp" name="mobile_otp" placeholder="OTP" >
            </div>
            <input type="hidden" id="event_name">
            ...
            <button class="login_btn" type="submit" name="verify_mobile" id="verify_mobile" style="font-family: Roboto;">Submit</button>
        </form>
    </div>
    <div class="col-md-3 col-xs-12"></div>
</div>
