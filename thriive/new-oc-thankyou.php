			...
			if($_POST['status'] == 'success' && $hash == $_POST["hash"]) {
	        	...
	        	<div class="container octhank">
		            ...
		            <div class="text-center mt-2" style="margin:bottom:10px;">
		                <h5 class="text-center">Thank you for your payment.<br/>We hope you have a wonderful session.</h5>
		            </div>
		            <?php if($_GET['a'] == 'call'){ 
		        	...
		        	<?php } 
					if($_GET['a'] == 'book_latercall' || $_GET['a'] == 'book_laterchat' ||  $_GET['a'] == 'videocall'){ 
			            ...
			            <div class="text-center ">
			                 <h5 class="text-center" style="margin:5px 5px;padding:5px 5px;">Your appointment has been confirmed with <?php echo $post->post_title; ?> </h5>
			            </div>
		        	<?php } 
					if($_GET['a'] == 'chat') { ?>
		        		...
		        		<div class="text-center footer_text">
			               ...
			               <h5 class="text-center" style="padding-left: 10px; padding-right: 10px;color: #666666d9;">Your Chat request has been sent to <?php echo $post->post_title; ?> please wait for therapist's confirmation. You will recieve a message Shortly.</h5>
			            </div>
			        <?php } ?>
			        <?php if($_GET['a'] == 'chat') {?>
					...
					<?php 	
					   if($_GET['t'] == 'tarot-card-reading' || $_GET['t'] == 'angel-reading' || $_GET['t'] == 'vastu-shastra' || $_GET['t'] == 'cosmic-astrology' || $_GET['t'] == 'numerology' || $_GET['t'] == 'all-prediction-page'){
						?>
