...
// New Design
	...
	jQuery('.therapy-list').on('change', '.add_therapy_section .sel .therapy-select', function () {
		...
		if (select_value != '') {
			...
			jQuery(this).parents('.add_therapy_section').find('.chg .therapy-chg').attr('required', true);
			jQuery(this).parents('.add_therapy_section').find('.parsley-errors-list li').html('Charges is required.');
		} else {
			...
			jQuery(this).parents('.add_therapy_section').find('.chg .therapy-chg').attr('required', false);
			jQuery(this).parents('.add_therapy_section').find('.parsley-errors-list li').html('');
		}
	});
	...
	jQuery('.therapy-list').on('change', '.add_therapy_section .chg .therapy-chg', function () {
		var select_value = this.value;
		if (select_value != '') {
			jQuery(this).parents('.add_therapy_section').find('.exp .therapy-exp').attr('required', true);
			jQuery(this).parents('.add_therapy_section').find('.parsley-errors-list li').html('Experience is required.');
...
*/	
	...
	// jQuery('#therapy-list_1').change(function (e) {
	// 	selected_therapy = $(this).find(':selected').data('id');
	// 	jQuery.ajax({
	// 		url: ajax_object.ajax_url,
	// 		type: 'POST',
	// 		data: {
	...
	// 		},
	// 		beforeSend: function () {
	// 			jQuery('.add_therapy_section .all_ailments .loader').show();
	// 		},
	// 		success: function (response) {
	// 			jQuery('.add_therapy_section .all_ailments .loader').hide();
	// 			var html = '';
	// 			var ail = jQuery('.add_therapy_section .all_ailments #sel_issue');
	// 			if (response == 'empty') {
	// 				ail.html('');
	...
	// 				//html = '<option value="">Search Issue</option>';
	// 				jQuery.each(data, function (k, v) {
	// 					html += '<input type="checkbox" name="' + v['slug'] + '" value="' + v['name'] + '">';
	// 				});
	// 			}
	// 			ail.html(html);
	// 			//jQuery('.add_therapy_section .all_ailments #sel_issue').val(selected_ailment);
	// 		},
	// 		error: function (err) {
	// 			console.log(err);
	// 		}
