...
if(from_role == 'subscriber')
{
	var titleStr = "<div class='widget-header widget-header-small' style='padding-left: 21px;'>" + to_user_name + "<button type='button' class='dots_iconz1' onclick='chat_dropDowns();'><span class='dotsA1'></span><span class='dotsA1'></span><span class='dotsA1'></span></button><div class='chat_dropdown_modal' style='display:none;'><ul class='chatdropdwn_lists'><li><button type='button' id= 'del' data-reload = '1' class = 'title_anch' data-to_user = '" + to_user_id + "' data-from_user = '" + from_user_id + "' onclick = 'delete_all(this)'>Delete</button></li><li><a href='https://www.thriive.in/faq-chat' class = 'title_anch' target='_blank' >FAQ</a></li></ul></div><button type='button' class='min_chatBox' onclick='minim_chatBox();'><img src='https://www.thriive.in/wp-content/themes/thriive/assets/images/minim_icon.png' alt='' /></button><button type='button' class='max_chatBox' onclick='maxim_chatBox();'><i class='fa fa-expand' aria-hidden='true'></i></button></div>";
}
		else
		{
				var titleStr = "<div class='widget-header widget-header-small' style='padding-left: 21px;'>" + to_user_name + "<button type='button' class='dots_iconz1' onclick='chat_dropDowns();'><span class='dotsA1'></span><span class='dotsA1'></span><span class='dotsA1'></span></button><div class='chat_dropdown_modal' style='display:none;'><ul class='chatdropdwn_lists'><li><button type='button' id= 'del' data-reload = '1' class = 'title_anch' data-to_user = '" + to_user_id + "' data-from_user = '" + from_user_id + "' onclick = 'delete_all(this)'>Delete</button></li><li><a href='https://www.thriive.in/faq-chat' class = 'title_anch' target='_blank' >FAQ</a></li><li><button type='button' data-toid='" + to_user_id + "' id='complete' class = 'title_anch' style='float:left' onclick='closeModal(" + to_user_id + ',' + from_user_id + ")' >Complete</button></li></ul></div><button type='button' class='min_chatBox' onclick='minim_chatBox();'><img src='https://www.thriive.in/wp-content/themes/thriive/assets/images/minim_icon.png' alt='' /></button><button type='button' class='max_chatBox' onclick='maxim_chatBox();'><i class='fa fa-expand' aria-hidden='true'></i></button></div>";
		}
               // console.log(data);
