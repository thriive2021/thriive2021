<?php /* Template Name: Ayurveda Therapist online consultation page */ 
...
<section class="hidden-xs" >
    <div class="container">
         <div class="row">
             <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform" <?php } ?>>
                 <img src="/wp-content/uploads/2020/09/AyurvedaHP_banner.jpg" class="img-responsive" alt="signup now" style="padding-top: 20px;">
             </div>
         </div>
     </div>
   ...
   <div class="container">	
		...
		<div class="row">
			...
			<div class="column" style="background-color:#fff; text-align:center;border: 1px solid #ccc;box-shadow: 1px 1px 3px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform1" <?php } ?>>
				<h3 class="packrup">₹ 299/-</h3>
				<hr>
				<p class="packdur">10 min +</p>
				<p class="freemin">5 min free</p>
			  </div>
			  <div class="column" style="background-color:#fff;text-align:center;border: 1px solid #ccc;box-shadow: 1px 1px 3px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform2" <?php } ?>>
				<h3 class="packrup" >₹ 499/-</h3>
				<hr>
				<p class="packdur">20 min +</p>
				<p class="freemin">10 min free</p>
			  </div>
			  <div class="column" style="background-color:#fff;text-align:center;border: 1px solid #ccc;box-shadow: 1px 1px 3px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform3" <?php } ?>>
				<h3 class="packrup">₹ 999/-</h3>
				<hr>
				<p class="packdur">40 min +</p>
				<p class="freemin">20 min free</p>
			  </div>
			</div>
			<div class="col-md-2"></div>
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform" <?php } ?>>
                <img src="/wp-content/uploads/2020/09/AyurvedaHP_banner.jpg" class="img-responsive" alt="signup now" style="width: 100%;padding-top: 20px;">
            </div>
        </div>
    </div>
      <div class="" style="clear: :both"></div>
...
<header class="">
	<div class="banner-home">
		<div class="container">			
			<h1 class="och1title">Consult trusted Ayurveda Experts online</h1>
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (13368,28032,44909,46312,64115,55904,52933)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','ayurveda');
