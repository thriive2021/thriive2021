<?php /* Template Name: New Pranic Healing online consultation page */ 
...
<section class="banner">
             <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform" <?php } ?>>
                 <img alt="pranic healers" title="pranic healers" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/11/Body-Listing-Page-2_Pranic-Healing_Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/11/Body-Listing-Page-2_Pranic-Healing_Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
             </div>
</section>
