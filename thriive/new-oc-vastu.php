<?php /* Template Name: New Vastu online consultation page */ 
...
$current_url = add_query_arg( array(), $wp->request ); ?>
 ...
 <style>
        ...
        @media only screen and (max-width: 580px) and (max-width: 767px)  {
			...
			.och1title{color: #27265F !important; text-align:left;margin-top: 18px;margin-bottom: 18px !important;font-weight: 600 !important; font-size:16px !important; text-align:center;}
...
<section class="banner" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Vastu-Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2021/01/Soul-Listing-Page_Vastu-Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
    </section>
	...
	<div class="banner-home">
		<div class="container">			
			<select id="select_therapy" class="form-control mb-2 mt-2">
                <option style="color:#231F20" value="<?php echo get_site_url()."/talk-to-astrologer-online"; ?>"<?php echo $current_url == 'talk-to-astrologer-online' ? 'selected': ''; ?>>Select Type of Reading</option>
                <option style="color:#231F20" value="<?php echo get_site_url()."/talk-to-best-astrologer-online"; ?>" <?php echo $current_url == 'talk-to-best-astrologer-online' ? 'selected': ''; ?>>Astrology</option>
                <option  style="color:#231F20" value="<?php echo get_site_url()."/talk-to-best-numerologist-online"; ?>" <?php echo $current_url == 'talk-to-best-numerologist-online' ? 'selected': ''; ?>>Numerology</option>
                <option  style="color:#231F20" value="<?php echo get_site_url()."/talk-to-best-tarot-card-reader-online"; ?>" <?php echo $current_url == 'talk-to-best-tarot-card-reader-online' ? 'selected': ''; ?>>Tarot Card Reading</option>
                <option  style="color:#231F20" value="<?php echo get_site_url()."/talk-to-best-angel-card-reader-online"; ?>"<?php echo $current_url == 'talk-to-best-angel-card-reader-online' ? 'selected': ''; ?>>Angel Card Reading</option>
				<option style="color:#231F20" value="<?php echo get_site_url()."/vastu"; ?>"<?php echo $current_url == 'vastu' ? 'selected': ''; ?>>Vastu</option>
            </select>
			  <div class="row">
			...
			if($getPost) : ?>
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('vastu-shastra'));
