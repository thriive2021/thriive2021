<?php /* Template Name: Astrology online consultation page */ 
	...
	<div class="banner-home">
		<div class="container">			
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (40307,10720,23958,54125,46893,35416,41592,27385,37615,44311,39555,53045,35345,36364,63873)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','cosmic-astrology');
...
<?php if (!is_user_logged_in()){ ?>
<div class="modal fade" id="connect_with_healer_login" data-backdrop="static" data-keyboard="false">
  <div class="modal-dialog <?php if (!is_user_logged_in()){ echo "modal-lg"; } ?>" role="document">
    <div class="modal-content">
      <div class="modal-body text-center">
	  	<?php
...
// include_once get_stylesheet_directory().'/footer1.php';
get_footer(); ?>
