<?php /* Template Name: Numerology online consultation page */ 
...
<header class="">
	<div class="banner-home">
		<div class="container">			
			...
			<h1 class="och1title">Talk to the Best Numerologists in India</h1>
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (28860,26884,14018,24785,22252,26271,56790,49358,48058,46673,46301,40534,24771,27840,29268,24228,27115,28115,43430,37610,8793,15613,28733,2456,53773,56111)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','numerology');
