...
<head>
  ...
  <style type="text/css">
    body{
      ...
      background-image: url("https://beta1.thriive.in/wp-content/themes/thriive/horoscope_new/New%20directory/Agora_Web_SDK_FULL/No-Video-Call2.svg");
    ...
    .end_button button{
    background-image: url(https://beta1.thriive.in/wp-content/themes/thriive/horoscope_new/New%20directory/Agora_Web_SDK_FULL/End-Call.svg);
    background-position: center;
    ...
    background-image: url(https://beta1.thriive.in/wp-content/themes/thriive/horoscope_new/New%20directory/Agora_Web_SDK_FULL/Video-Call.svg);
    background-position: center;
    background-size: contain;
    width: 4rem;
    background-repeat: no-repeat;
  ...
  <script type="text/javascript">
      ...
      $.post('video_functions.php',{channel:channel, action:action, status:status, time_spent:time_spent, role:role}, function(data){
        ...
        if(vctwo == 1 && role == 'utime'){
        	...
        	document.querySelector('.block_video').style.backgroundImage = "url('https://beta1.thriive.in/wp-content/themes/thriive/horoscope_new/New%20directory/Agora_Web_SDK_FULL/No-Video-Call.svg')";
        }else if(vctwo == 0 && role == 'utime'){
        	document.querySelector('#local-player video').style.display = 'block';
        	document.querySelector('.block_video').style.backgroundImage = "url('https://beta1.thriive.in/wp-content/themes/thriive/horoscope_new/New%20directory/Agora_Web_SDK_FULL/Video-Call.svg')";
        ...
        if(vcone == 1 || vcfour == 1){
          location.href = "https://beta1.thriive.in/my-account-page";
          }
      });
      }
      function end_call(){
