		...
		<div class="container">			
			...
			<div id="therapyres">	
				...
				$getPost = $wpdb->get_results( 
					"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (9211,29032,28454,23208,53710,30352,66455,51880,19866)"
				);
