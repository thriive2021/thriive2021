<?php /* Template Name: Weekly-Horoscope	 */
...
<div class=zod-list>
		...
		<h1 class="todays_horo_head">Weekly Tarot Horoscope</h1><br>
 ...
 <div class="seprator mb-3">
  <img src="<?php echo get_template_directory_uri() .'/assets/images/newsoulimg/seperator.svg';?>" alt="">
		...
		<p></p>
		<button class="btnConsult daily_horo_page_btn" style="margin-bottom: 1rem;" onclick="window.open('<?php echo get_site_url();?>/talk-to-best-astrologer-online?utm_source=weekly-horoscope');">Consult Now</button>
	</div>
