		...
		<div class="container">			
			...
			<div id="therapyres">	
				...
				$getPost = $wpdb->get_results( 
					"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (4966,6215,2550,64394,59573,25811,35674,36203,6186,51880)"
				);
