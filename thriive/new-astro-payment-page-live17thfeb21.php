...
<div class="container">
	...
	<div class="row">
		...
		<div class="col-md-12 col-xs-12">
			...
			if( have_rows('package_details','option') ):
				...
				//	echo "<pre>";print_r(get_sub_field('call_packages'));
	...
	<div class="">
		<p class="textdesc">A pack of multiple sessions can be used across different Soul Therapies and Therapists within 12 Months</p>
	</div>
