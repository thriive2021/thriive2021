<?php /* Template Name: Sex Therapist online consultation page */ 
    ...
    <div class="container">
         <div class="row">
             <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform" <?php } ?>>
                 <img src="/wp-content/uploads/2020/09/Desktop-Banner.jpg" class="img-responsive" alt="signup now" style="padding-top: 20px;">
             </div>
         </div>
     </div>
     ...
     <div class="container">
        <div class="row">
            <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform" <?php } ?>>
                <img src="/wp-content/uploads/2020/09/Mobile-Banner.jpg" class="img-responsive" alt="signup now" style="width: 100%;padding-top: 20px;">
            </div>
        </div>
    </div>
      <div class="" style="clear: :both"></div>
...
<header class="">
	<div class="banner-home">
		<div class="container">			
			<h1 class="och1title">Consult Top Sex Therapists online</h1>
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (53487,29668,56787,44854)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','sex-therapist');
