<?php /* Template Name: Meditation online consultation page */ 
...
<header class="">
	<div class="banner-home">
		<div class="container">			
			...
			<h1 class="och1title">Connect with Top Meditation Coach</h1>
			<?php
			$posts_per_page = 4;
			$start = 0;
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (54569,53551,54119,54126,49857,19481,49935,47853,47709,32952,14577,36293,35010,32706,45481,47709,32952,35010,35299)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','meditation');
