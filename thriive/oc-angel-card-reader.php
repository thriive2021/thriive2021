<?php /* Template Name: Angel card online consultation page */ 
...
<header class="">
	<div class="banner-home">
		<div class="container">			
			...
			<h1 class="och1title">Talk to the Best Angel Card Readers in India</h1>
			...
			$getPost = $wpdb->get_results( 
				"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (29910,7785,8249,39039,26595,29520,33975,35762,40014,5405,26380,16414,57287,28733)"
			);
				...
				<div class="therapist-wrapper section-loop-wrapper row">
					<div class="section_therapies_list therapiest_list col-12 col-sm-8 p-sm-0">
                        ...
                        foreach($tempArr as $t){
                            ...
                            // }
                            setup_postdata( $post );
                            set_query_var('therapy','angel-reading');
