<?php /* Template Name: New Ayurveda Therapist online consultation page */ 
...
<section class="banner">
             <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform" <?php } ?>>
                 <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/12/Body-Listing-Page_Ayurda-Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/12/Body-Listing-Page_Ayurveda-Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
             </div>
</section>
			...
			if($getPost) : ?>
				...
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('ayurveda'));
