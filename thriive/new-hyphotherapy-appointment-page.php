		...
		<div class="container">			
			...
			<div id="therapyres">	
				...
				$getPost = $wpdb->get_results( 
					"SELECT DISTINCT p.ID FROM wp_posts AS p WHERE p.post_type = 'therapist' AND (p.post_status = 'publish' OR p.post_status = 'acf-disabled') AND p.ID IN (20224,27843,51880,5063,6215,11881,49202,24713,57608)"
				);
