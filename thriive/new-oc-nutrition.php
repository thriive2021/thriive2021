<?php /* Template Name: New Nutrition Expert online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/12/Body-Listing-Page_Nutrition-Mobile.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/12/Body-Listing-Page_Nutrition-Desktop.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
</section>
               ...
               <div class="row">
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_purple" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_purple f_18">Trial</h5>
						   <h5 class="c_purple text-center f_15">15 mins</h5>
                   ...
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_red" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_pink f_18">2 Sessions</h5>
						   <h5 class="c_pink text-center f_15">30 mins each</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;width: 80%;">
                   ...
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_blue" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_blue f_18">4 Sessions</h5>
						   <h5 class="c_purple text-center f_15">30 mins each</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;width: 80%;">
                           <h5 class="c_red text-center f_15">&#8377; 1599/-</h5>
                       </div>
                   </div>
               </div>
           </div>
			...
			if($getPost) : ?>
				...
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('nutritionist'));
