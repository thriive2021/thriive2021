<?php /* Template Name: New Free Vastu online consultation page */ 
...
<header class="">
    <div class="banner-home">
        <div class="container">         
            ...
            // Loop Start
            if($getPost) { ?>
                <h1 class="och1title">Consult Best Vastu Shastra Expert</h1>
...
<div class="">
  ...
  <h4 class="ftnc">Terms & Conditions for a trial sessions</h4>
	<div class="container">
		<div class="row">
				<ul class="ftncul">
