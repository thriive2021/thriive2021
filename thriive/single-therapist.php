            ...
            <div class="d-flex col-12 col-sm-12 mt-20 wrapper-listing section-wrapper-listing p-0 flex-wrap therapiest-detail-header">
                <div class=" d-flex flex-wrap col-12 p-0">
                    <div class="col-5 col-sm-6 col-lg-4 wrapper-listing-post ">
                        <?php if(is_mobile()){?>
                        <div class="healer-circle mt-3" style="width: 130px !important;height: 130px !important;">
                    ...
                    <div class="col-7 col-sm-6 col-lg-8 txt-wrap ">
                        <h1 class="tdtitle"><a href="<?php echo get_permalink(); ?>"><?php echo get_the_title(); ?></a></h1>
                        ...
                        <?php if(!is_mobile()) { ?>
                        <p class="m-0 font-14 tt-text"><b>Therapies</b>:
                            <span class="">
                                <?php 
                        ...
                        <!-- <p class="m-0">
							...
							foreach($therapy_experiences as $i=>$therapy_experience) {
								$experience_order [$i] = $therapy_experience['experience'];
							}
                        ...
                        <?php } else { ?>
                        	<p style="font-family: Segoe UI;" class=' m-0'>
                            	<span itemprop="addressLocality"><?php echo getTherapistCity(get_the_id()); ?></span>
                        	</p>
                        <?php } ?>
                        </p>
                        <?php } ?>
...
<button type="button" class="btn btn-info btn-xs btn-big start_chat" data-img ="'.$url.'" data-fromuserid = "'.$seeker_id.'" data-touserid="'.$therapist_id.'" data-tousername="'.$name.'" data-from_status = "'.$from_status.'" data-to_status = "'.$to_status.'" data-mobile="'.$therapist_countrycde[0].$therapist_mobile[0].'" data-msg="'.$msg.'" data-email="'.$therapist_email.'"  data-role="'.$role1.'" style="display:none;"><i class="fa fa-comments-o" aria-hidden="true"></i>Chat Now</button></div>';
$output .= '</div>';
		...
		?>
					...
					if(wp_is_mobile() && ($role1 == 'subscriber' || $role1 =="")){
						 ?>
                            <a href="" id="call_now_<?php echo get_the_id(); ?>" class="btn btn-primary btn-big call_now_link" style="margin: 0px 15px;border-radius: 5px; display: none;"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a>
...
?>
						...
						?>
                            <a href="" id="consult_online_<?php echo get_the_id(); ?>" data-type="1" class="btn btn-primary btn-big consult_online_link" style="display: none;"><i class="fa fa-phone" aria-hidden="true"></i> Call Now</a>
...
?>
                ...
                <div class="hidden-md hidden-lg hidden-xl" style="margin-top:-10px">
                        <?php if(is_mobile){ ?>
                        <p class="m-0 mt-1 font-14 tt-text"><b>Therapies</b>:
                            <span class="">
                                <?php 
								$total_count = count(get_field("therapy"));
								$count = 1;
...
<!--                    <a href="" class="btn share-cta share-event-wrapper mb-3"><i         class="icon-new-share p-1"></i>SHARE</a>-->
                    <div class="text-left thriive-social-block social-block-list show-block mt-3 hidden-lg hidden-md hidden-xl">
...
<div>
    <pre><?php //print_r($therapies);?></pre>
</div> <?php
	if($therapies) {
	
?>
<section class="section transperrent-section therapy-detail-section" id="2">
    <div class="container">
        <div class="text-left">
            <h2 class="tdsectitle">Therapy</h2>
        </div>
                    ...
                    <div class="swiper-slide">
                        <div class="col-12 pl-0 pr-2">
                            <div class="blog-img-list left-img mb-1">
                                <?php echo wp_get_attachment_image($my_blog['blog_image']['ID'],'medium'); ?>
                            </div>
                            <h5 class="tblogtitle"><a href="<?php echo $my_blog['blog_link']; ?>" target="_blank"><?php echo $my_blog['blog_title']; ?></a></h5>
...
if($gallery_images || $gallery_videos) {
?>
<section class="section transperrent-section gallery-section" id="5">
    <div class="container">
        <h2 class="tdsectitle">Gallery</h2>
            ...
            <div class="swiper-container swiper-home-blog w-100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <h6 class="tblogtitle"><?php echo ucwords($gallery_image['gallery_title']); ?></h6>
                    </div>
                    <?php }?>
                </div>
                <!-- Add Arrows -->
            ...
            <div class="swiper-container swiper-home-blog w-100">
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        ...
                        <h6 class="tblogtitle"><?php echo ucwords($gallery_video['video_title']); ?></h6>
                    </div>
                    <?php
							}
						?>
...
<?php //$user_comments = get_comments (array('post_id'=>$post_id));
	...
	if(get_field("first_reference_review", $post_id) != "" || get_field("second_reference_review", $post_id) != "" || get_field("third_reference_review", $post_id) != "" || get_field("review_details", $post_id)) { ?>
<section class="text-center container therapy-detail-review-section mt-3" id="7">
    <div class="col-md-12 col-xs-12 text-center">
        <h2 class="tdsectitle">Testimonials</h2>
    </div>
    <div style="clear:both;"></div>
    <div class="text-center section row">
        <div class="swiper-container">
            <div class="swiper-wrapper">
                <?php if(get_field("first_reference_review", $post_id) != "") { ?>
                <div class="swiper-slide">
                ...
                <?php } if(get_field("second_reference_review", $post_id) != "") { ?>
                <div class="swiper-slide">
                ...
                <?php } if(get_field("third_reference_review", $post_id) != "") { ?>
                <div class="swiper-slide">
                ...
                <?php } if(get_field("review_details", $post_id) != "") {
                	while ( have_rows('review_details', $post_id) ) : the_row(); 
                		if((!empty(get_sub_field('review'))) && (!empty(get_sub_field('status'))) && (count(get_sub_field('by')) > 1)){ ?>
