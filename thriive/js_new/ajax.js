function make_chat_dialog_box(to_user_id, to_user_name, from_user_id = '', user_role = "", img = "") {
    ...
    modal_content += '<label for="file-1" class="file_txtlabel"><img src="http://35.185.177.205/wp-content/themes/thriive/assets/images/attachment_icon1.png" class="upload_iconn" alt="upload Icon"><input type="file" id="selectFile" class="inputFile_box" data-id="' + to_user_id + '_' + from_user_id + '" style="float:left" onchange= "upload(this)" /></label><span id="msg" style="color:red;display:none;" class="filetype_pic"></span>';
...
{
	var titleStr = "<div class='widget-header widget-header-small' style='padding-left: 21px;'>" + to_user_name + "<button type='button' class='dots_iconz1' onclick='chat_dropDowns();'><span class='dotsA1'></span><span class='dotsA1'></span><span class='dotsA1'></span></button><div class='chat_dropdown_modal' style='display:none;'><ul class='chatdropdwn_lists'><li><button type='button' id= 'del' data-reload = '1' class = 'title_anch' data-to_user = '" + to_user_id + "' data-from_user = '" + from_user_id + "' onclick = 'delete_msggrp(this)'>Delete</button></li><li><a href='http://35.185.177.205/faq-chat' class = 'title_anch' target='_blank' >FAQ</a></li></ul></div><button type='button' class='min_chatBox' onclick='minim_chatBox();'><img src='http://35.185.177.205/wp-content/themes/thriive/assets/images/minim_icon.png' alt='' /></button><button type='button' class='max_chatBox' onclick='maxim_chatBox();'><i class='fa fa-expand' aria-hidden='true'></i></button></div>";
}
		else
		{
				var titleStr = "<div class='widget-header widget-header-small' style='padding-left: 21px;'>" + to_user_name + "<button type='button' class='dots_iconz1' onclick='chat_dropDowns();'><span class='dotsA1'></span><span class='dotsA1'></span><span class='dotsA1'></span></button><div class='chat_dropdown_modal' style='display:none;'><ul class='chatdropdwn_lists'><li><button type='button' id= 'del' data-reload = '1' class = 'title_anch' data-to_user = '" + to_user_id + "' data-from_user = '" + from_user_id + "' onclick = 'delete_msggrp(this)'>Delete</button></li><li><a href='http://35.185.177.205/faq-chat' class = 'title_anch' target='_blank' >FAQ</a></li><li><button type='button' data-toid='" + to_user_id + "' id='complete' class = 'title_anch' style='float:left' onclick='closeModal(" + to_user_id + ',' + from_user_id + ")' >Complete</button></li></ul></div><button type='button' class='min_chatBox' onclick='minim_chatBox();'><img src='http://35.185.177.205/wp-content/themes/thriive/assets/images/minim_icon.png' alt='' /></button><button type='button' class='max_chatBox' onclick='maxim_chatBox();'><i class='fa fa-expand' aria-hidden='true'></i></button></div>";
		}
...
function maxim_chatBox() {
    ...
    $('.max_chatBox .fa').toggleClass("fa-expand fa-compress");
