<?php /* Template Name: New Theta Healing Expert online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Theta-Healing-Mobile-1.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Theta-Healing-Desktop-1.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
</section>
			...
			if($getPost) : ?>
				...
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('theta-healing'));
