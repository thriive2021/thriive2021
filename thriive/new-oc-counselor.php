<?php /* Template Name: New Counselor online consultation page */ 
...
<section class="banner">
             <div class="col-md-12" style="padding: 0px;" <?php if (!is_user_logged_in()){ ?>id="d_opensignupform" <?php } ?>>
                 		<img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/12/Home-Page-Banner-Mobile-806x431-1-2.png';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/12/Home-Page-Banner-Desktop-1280x400-1.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
               ...
               <div class="row">
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_purple" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_purple f_18">10 mins</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;">
