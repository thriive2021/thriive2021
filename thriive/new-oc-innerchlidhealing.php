<?php /* Template Name: New Inner Child Healing Expert online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Inner-Child-Mobile-1.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Inner-Child-Desktop-1.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
</section>
