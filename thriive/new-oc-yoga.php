<?php /* Template Name: New Yoga Expert online consultation page */ 
...
<section class="banner">
        <img alt="" class="img-responsive banner_image" src="<?php if (is_mobile()) {echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Yoga-Mobile-1.jpg';
		}else{echo 'https://www.thriive.in/wp-content/uploads/2020/10/Body-Listing-Page_Yoga-Desktop-1.jpg';}?>" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>  style="border-radius: 0px"/>
</section>
               ...
               <div class="row">
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_purple" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_purple f_18">20 mins</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;width: 80%;">
                           <h5 class="c_red text-center f_15">&#8377; 199/-</h5>
                       </div>
                   </div>
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_red" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_pink f_18">40 mins</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;width: 80%;">
                           <h5 class="c_red text-center f_15">&#8377; 399/-</h5>
                       </div>
                   </div>
                   <div class="col-md-4 col-xs-4">
                       <div class="box_in_blue" <?php if (!is_user_logged_in()){ ?>id="m_opensignupform1" <?php } ?>>
                           <h5 class="text-center c_blue f_18">60 mins</h5>
                           <hr style="margin-bottom: 5px;margin-top: 0px;border-top: 2px solid #eee;width: 80%;">
                           <h5 class="c_red text-center f_15">&#8377; 599/-</h5>
                       </div>
                   </div>
               </div>
           </div>
			...
			if($getPost) : ?>
				...
				<section class="topreadingList">
                    ...
                    foreach($tempArr as $t){
                        ...
                        // }
                        setup_postdata( $post );
                        set_query_var('therapy',array('yoga','ashtanga-yoga','hatha-yoga'));
