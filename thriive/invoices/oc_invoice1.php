...
<body>
	...
	<table class="product-details">
		...
		<tr>
			...
			<?php 
				...
				$amountWithoutTax = ($amountWithTax / 18)*100;
				$netAmt = $amountWithTax-$amountWithoutTax;
				$thriiveAmt = number_format(($amountWithTax / 30)*100, 2, '.', '');
				$expertAmt = number_format($netAmt-$thriiveAmt, 2, '.','');
	...
	<?php }*/ ?>
		<tr>
			...
			<td class=""></td>
			<td class="text-right">18 %</td>
			<td class="text-right"><?php echo $amountWithoutTax; ?></td>
		</tr>
		<tr>
			<td class="text-right">Expert Amount</td>
			<td class=""></td>
			<td class="text-right">70 %</td>
			<td class="text-right"><?php echo $expertAmt; ?></td>
		</tr>
		<tr>
			<td class="text-right">Thriive Amount</td>
			<td class=""></td>
			<td class="text-right">30 %</td>
			<td class="text-right"><?php echo $thriiveAmt; ?></td>
		</tr>	
		<tr>						
